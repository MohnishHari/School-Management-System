...
import com.app.registration.repository.ClassRepository;
import com.app.registration.service.ResourceNotFoundException2;
...
public class ClassController {
    ...
    public ResponseEntity<Class> getClassById(@PathVariable Long id){
    	Class class1 = classRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException2("Class with id '"+id+"' does not exist"));
